...
import br.com.targettrust.persistencia.model.Aluno;
import br.com.targettrust.persistencia.model.Endereco;
import br.com.targettrust.persistencia.model.Perfil;
import br.com.targettrust.persistencia.model.Professor;
...
public class GravaUsuarios {
	...
	public static void main(String[] args) throws SQLException {
		...
		Turma javaFund,javaJPA;
		
		javaFund = new Turma("JAVA Fundamentos",'3');
		javaJPA	= new Turma("JPA & MOR",'1');
...
//		u1end3.setUsuario(u1);
		...
		u2.setSexo(Sexo.F);
		u2.setEspecializacao("Doutorado");
		u2.setPerfil(Perfil.V);
		// u1.setSalario(2550.78);// erro pois esse literal não é BigDecimal
		...
		javaFund.addUsuario(u1);
		javaJPA.addUsuario(u2);
		javaFund.addUsuario(u2);				
